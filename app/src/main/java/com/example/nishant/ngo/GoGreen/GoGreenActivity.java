package com.example.nishant.ngo.GoGreen;
...
public class GoGreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("GoGreenuploads");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("GoGreenuploads");

        viewGallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GoGreenActivity.this, ViewImageActvity.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(GoGreenActivity.this, "Upload in progress", Toast.LENGTH_LONG).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
            ...
            mUploadTask = fileReference.putFile(imgUrl)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(GoGreenActivity.this, "Upload successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(GoGreenActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(GoGreenActivity.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
}
